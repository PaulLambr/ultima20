...
def foyer():
    ...
    while True:
        ...
        if (
            choice in ["attack hobbit with poker", "attack", "attack hobbit"]
            and "poker" in inventory
        ):
...
while True:
    ...
    if choice == "look at hobbit":
        ...
        choice in ["speak the words that free", "say the words that free"]
        and areinvisible
    ):
        print(
        ...
        choice in ["search room", "look around room", "l", "look"]
        and arefree
        and not hasbeensaidonce
    ):
        print(
